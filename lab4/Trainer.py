...
class kl_annealing():
    ...
    def get_beta(self, epoch):
        ...
        if self.args.kl_anneal_type == 'No': 
            ...
            beta = self.frange_cycle_linear(self.args.num_epoch,1e-6, 1.0,  self.args.kl_anneal_cycle, self.args.kl_anneal_ratio)
            # print(beta)
            return max(beta[epoch], 1e-6)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epoch',     type=int, default=600,     help="number of total epoch")
